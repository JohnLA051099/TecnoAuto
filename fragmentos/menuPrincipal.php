    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-justified nav-underline">
                ...
                <li class="nav-item">
                    <a class="nav-link fs-5 fw-medium transicion cerrar text-white" href="nosotros.php">Nosotros</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu transicion cerrar text-white">
                        <li><a class="dropdown-item" href="taller.php">Taller mecanico</a></li>
                ...
                <li class="nav-item">
                    <a class="nav-link fs-5 fw-medium transicion cerrar text-white" href="contacto.php">Contacto</a>
                </li>
                <liv class="nav-item">
